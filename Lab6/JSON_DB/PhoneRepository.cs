...
namespace JSON_DB
{
    public sealed class PhoneRepository : IRepository<Phone>
    {
        ...
        public void SaveModel()
        {
            ...
            File.WriteAllText(@"D:\Studying\Course_3\Second_2sem\ASP.NET\Labs\Lab6\JSON_DB\PhonesDB.json", json);
        }

        public void LoadModel()
        {
            Phones = JsonSerializer.Deserialize<List<Phone>>(File.ReadAllText(@"D:\Studying\Course_3\Second_2sem\ASP.NET\Labs\Lab6\JSON_DB\PhonesDB.json"));
        }
